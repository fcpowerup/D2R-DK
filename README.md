...
- `D2R-DK_v0.1.6_build2609220217_p.exe`
- 同目录哈希文件 `D2R-DK_v0.1.6_build2609220217_p.txt`（可用 SHA256 自检）

当前版本：**0.1.6** · build **`2609220217_p`** · 国服 / 国际服批量多开。

**SHA256**

```text
89D4FD9F00E8649D7740CE02789073A57344D76237A32D39C809079F01C4A75A
```
